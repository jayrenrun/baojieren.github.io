$(document).ready(function () {
    ...
    view.scroll(function () {
        ...
        var scrollInt = parseInt(scrollPosition / 10);
        ...
        var c1 = (255 - colorNum) + ',' + (255 - colorNum) + ',' + (255-colorNum);
        var c2 = (89) + ',' + (98) + ',' + (112);
        // body.css({backgroundPosition:'0px -'+scrollPosition+'px'});
        body.css({background: 'linear-gradient(to bottom right, rgb(' + c1 + '), rgb(' + c2 + '))'});
    });
